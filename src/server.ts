...
const TRUST_PROFILES: Record<string, any> = {
  divya: {
    ...
    managingTrustee: process.env.MANAGING_TRUSTEE || 'Sri Pratap Maharaj',
    merchantEmail: process.env.PRIMARY_MERCHANT_EMAIL || 'pratapmaharaj9@gmail.com',
    pan: process.env.PRIMARY_TRUST_PAN || 'AAFTD5153Q',
    bankName: process.env.PRIMARY_BANK_NAME || 'State Bank of India',
  ...
  relaxation: {
    id: 'relaxation',
    name: process.env.SECONDARY_PROJECT_NAME || 'The Art Of Relaxation',
    ...
    managingTrustee: process.env.MANAGING_TRUSTEE || 'Sri Pratap Maharaj',
    merchantEmail: process.env.SECONDARY_MERCHANT_EMAIL || 'vpmaor@gmail.com',
    pan: process.env.SECONDARY_TRUST_PAN || 'AACTT7999K',
    bankName: process.env.SECONDARY_BANK_NAME || 'Karur Vysya Bank',
